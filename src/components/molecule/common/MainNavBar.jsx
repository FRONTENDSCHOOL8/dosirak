...
const MainNavBar = () => {
  return (
    <section className="fixed bottom-0 z-20 flex h-[95px] w-[430px] min-w-[372px] justify-center bg-white px-[45px] pb-[35px] pt-5 shadow-[0_-4px_4px_0_rgba(204,204,204,0.25)] mobile:w-screen">
